...
function renderDevBadge() {
  $("#btn-devmode").classList.toggle("on", state.devMode.enabled);
  $("#btn-devmode").textContent = state.devMode.enabled ? "DEV ON" : "DEV";
}
...
function toggleAnnotate() {
  ...
  $("#btn-annotate").classList.toggle("active", state.annotateMode);
...
$("#btn-frame").addEventListener("click", () => {
  ...
  $("#btn-frame").classList.toggle("active", state.iframeMode);
